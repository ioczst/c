...
void show_help_children(const AVClass *class, int flags)
{
    ...
    void *iter = NULL;
    while (child = av_opt_child_class_iterate(child, &iter))
...
static void show_help_filter(const char *name)
{
    ...
    printf("    Inputs:\n");
    count = avfilter_filter_pad_count(f->inputs, f->nb_outputs);
    ...
    printf("    Outputs:\n");
    count = avfilter_filter_pad_count(f->outputs ,f->nb_inputs);
